...
export default async function Page() {
  return (
    <main
      className={`z-20 mt-28 md:mb-10 md:mt-32 w-full md:w-5/6 lg:w-4/6 lg:max-w-[900px] h-full min-h-screen px-8 py-10 bg-EpaWhite text-Black flex flex-col items-center gap-4 md:rounded-xl`}
    >
