      ...
      <div className=" relative w-full lg:max-w-4xl flex flex-col items-center gap-8">
        <section className="w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            regulan el uso del servicio denominado “{dictionary['site']}” (en
        ...
        <section className=" w-full flex flex-col gap-4">
          <Title2Styled>EL SERVICIO: {dictionary['site']}</Title2Styled>
          <ParagraphStyled>
            {dictionary['site']} es un servicio de entretenimiento que permite
            acceder al cliente, a través de un celular, Tablet o computadora, en
            las condiciones que se detallan en estos Términos y Condiciones.
          </ParagraphStyled>
          <ParagraphStyled>
          ...
          <ParagraphStyled>
            ...
            disfrutar sin límites de todo el contenido que ofrece{' '}
            {dictionary['site']}. Los cargos por navegación y transmisión de
            datos no están incluidos en el servicio. Los usuarios también podrán
            suscribirse a través de la página web de la Operadora, en la sección
            opciones de entretenimiento digital, seleccionando la opción de{' '}
            {dictionary['site']}, a través del URL propio del servicio{' '}
            <Link className=" text-sky-600 " target="_blank" href={'/'}>
              {dictionary['site']}
            </Link>{' '}
          ...
          <ParagraphStyled>
            {dictionary['site']} enviará desde el número 111 un mensaje de texto
            con la información de acceso al portal y el precio al menos una vez
            al mes. Adicionalmente, {dictionary['site']}, enviará al usuario
