...
import TitleStyled from '@/app/components/paragraph/TitleStyled'
import Title2Styled from '@/app/components/paragraph/Title2Styled'
import ParagraphStyled from '@/app/components/paragraph/ParagraphStyled'

import dictionary from '@/dictionary/lang.json'
export default async function Page() {
  return (
    <main
      className={` relative z-20 w-full max-w-screen-xl h-full min-h-screen px-6 py-6 md:mb-10 xl:py-10 overflow-y-hidden  text-black flex flex-col items-center gap-4 md:rounded-xl bg-white`}
    >
      <div className=" relative w-full lg:max-w-4xl flex flex-col items-center gap-8">
        <section className="w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            use of the service called “{dictionary['site']}” (here in after
            referred to as the “Service” or the “Entertainment Option”) offered
            by MOOB MEDIA BUSINESS, C.A (the “Provider”), through which users of
            XXXXXX – (hereinafter the “Operator”) may access from their mobile
            device, tablet, laptop or PC, dedicated fitness content, where they
            can enjoy updates, videos, routines and tips from personal trainers.
          </ParagraphStyled>
        </section>
        <section className=" w-full flex flex-col gap-4">
          <Title2Styled>THE SERVICE: {dictionary['site']}</Title2Styled>
          <ParagraphStyled>
            {dictionary['site']} is an entertainment service that allows the
            customer to access fitness content via mobile phone, tablet or
            computer, where they can enjoy updates, videos, routines and tips
            from personal trainers, under the conditions detailed in these Terms
            and Conditions.
          </ParagraphStyled>
          <ParagraphStyled>
          ...
          <ParagraphStyled>
            ...
            <span className=" font-semibold">
              SUBS, or the command communicated for this action, to the number
              XXXX
            </span>
            ...
            to enjoy all the content offered by {dictionary['site']} without
            limits. Data browsing and transmission charges are not included in
            the service. Users may also subscribe through the XXXXX website, in
            the digital entertainment options section, by selecting the Total
          ...
          <ParagraphStyled>
            ...
            <span className=" font-semibold">CANCEL to the number XXXX</span>{' '}
          ...
          <ParagraphStyled>
            {dictionary['site']} will send from the number XXXX a text message
            with the access information to the portal and the price at least
            once a month. In addition, {dictionary['site']} will send users text
            messages with relevant information during periods when sweepstakes,
            awards and/or activities of interest to the segment are held.
          </ParagraphStyled>
          <ParagraphStyled>
